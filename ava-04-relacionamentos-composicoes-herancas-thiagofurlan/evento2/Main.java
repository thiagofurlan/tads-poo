class Main {
	...
	public static void main(String[] args) {
		Evento ev1 = new Evento("Semana Acadêmica IFRS", "Rio Grande", new Semana());

		// atividades tem vagas e carga horária opcionais
		Atividade atv1 = ev1.novaAtividade("Seminário TCCs TADS", 40, new Seminario());
		Atividade atv2 = ev1.novaAtividade("Minicurso ECMA6", 20, 8, new Minicurso());

		// dados do evento
		System.out.println(ev1.getNome().equals("Semana Acadêmica IFRS"));
		System.out.println(ev1.getTipo().toString() == "Semana");
		...
		System.out.println(atv1.getTipo().toString() == "Seminário");
		...
		System.out.println(atv2.getTipo().toString() == "Minicurso");
		...
		Evento ev2 = new Evento("Escola Regional de Banco de Dados", "Bagé", new Escola());
		Atividade atv3 = ev2.novaAtividade("BigData com Apache Hadoop", "Paulo Silva", 20, 4, new Oficina());
		Atividade atv4 = ev2.novaAtividade("Data Science: uma introdução", "Maria Santos", new Palestra());
		...
		System.out.println(atv3.getTipo().toString() == "Oficina");

		// um evento que abriga (tem) outros eventos:
		Evento ev3 = new Evento("3º Salão de Pesquisa, Extensão e Ensino do IFRS", "Bento Gonçalves", new Salao());
		EventoSatelite sat1 = ev3.novoEventoSatelite("7º Seminário de Iniciação Científica e Tecnológica (SICT)", new Seminario());
		EventoSatelite sat2 = ev3.novoEventoSatelite("5º Seminário de Educação Profissional e Tecnológica (SEMEPT)", new Seminario());
		EventoSatelite sat3 = ev3.novoEventoSatelite("Mostra de Arte e Cultura", new Mostra());
		...
		System.out.println(atv4.getTipo().toString() == "Palestra");
